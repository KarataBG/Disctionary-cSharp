...
namespace SDA__46501_MyProject
{
    public partial class GermanForm : Form
    {
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                label1.Text = form1.deDict[listBox1.Items[listBox1.SelectedIndex].ToString()];
            }

        }

        private void GermanForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            Environment.Exit(0);
        }
        ...
        {
            form1.deleteEntry(null, listBox1.SelectedItem.ToString());
            init();
        }
        ...
        private void searchByLetter_Click(object sender, EventArgs e)
        {
            ...
            listBox1.Items.Clear();
            List<string> entry = form1.deDict.Keys.ToList();
